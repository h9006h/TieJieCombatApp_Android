(() => {
  ...
  const assets={
    ...
    barbarianSprintSheet:image('assets/fighter/normalized/enemy-barbarian-sprint-4-strip-v1.webp?v=1.0'),
  ...
  assets.fighterShadows={
    ...
    barbarianSprintSheet:image('assets/fighter/normalized/shadows/enemy-barbarian-sprint-4-strip-v1.webp?v=1.0'),
