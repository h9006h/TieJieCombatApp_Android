(() => {
  ...
  function prepareRecruitment(){
    recruitmentPaid=false;if(selectedRecruitTypes.size===0)return true;
    ...
    if(!free){progress.gold-=total;saveProgress();recruitmentPaid=true}
    return true
  }
  ...
  const defaultEnemyFrameScales={"skinnyBase":[1,1,1,1,1],"skinnyWalk":[1,1,1,1],"skinnySlide":[1],"spinnerBase":[0.86,0.86,0.86,0.86,0.86],"spinnerSpin":[0.86,0.86,0.86,0.86],"suitBase":[1,1,1,1,1],"barbarianBase":[1.18,1.18,1.18,1.18,1.18],"barbarianRevive":[1.18,1.18,1.18,1.18]};
  ...
  document.querySelector('#level-select').onclick=()=>{const p=document.querySelector('#level-panel');p.hidden=!p.hidden};
