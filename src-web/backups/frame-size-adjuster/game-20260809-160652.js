(() => {
  ...
  function drawHeroSprite(a,x,y,face,state,phase){
    ...
    if(state.startsWith('punch')&&heroPunchComboSheet.complete){
      ...
      const p=clamp(1-a.timer/.78,0,.9999),frame=Math.min(3,Math.floor(p*4)),frameY=[-2,-1,-1,-1];paintN(heroKick3Sheet,4,frame,.371,0,frameY[frame],1,'none');
