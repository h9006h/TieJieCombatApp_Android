(() => {
  ...
  function drawWalkSprite(a,x,y,face,phase,paintGroundShadow){
    const frameStep=paintGroundShadow?0.9:1.5,frame=Math.floor(phase/frameStep)%8,sw=heroWalkSheet.naturalWidth/8,sh=heroWalkSheet.naturalHeight,scale=enemyFrameScale('heroWalk',frame,1),dw=sw*scale,dh=sh*scale,frameShifts=[0,0,0,0,0,0,0,0];
